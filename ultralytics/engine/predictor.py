...
from ultralytics.data.augment import LetterBox, classify_transforms, classify_albumentations
...
class BasePredictor:
    ...
    def setup_source(self, source):
        ...
        self.transforms = getattr(self.model.model, 'transforms', classify_albumentations(self.args.mode == 'train',
